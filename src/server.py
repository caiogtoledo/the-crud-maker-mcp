...
def create_entity_test(entity_name: str, fields: dict[str, str]) -> str:
    """Generates an entity test file content following the entity test example."""
    return create_entity_test_tool(entity_name, fields)

@mcp.tool(name="create_repository_interface")
def create_repository_interface(repository_name: str, methods: dict[str, str]) -> str:
    """Generates an repository interface file content following the repository interface example."""
    return create_repository_interface_tool(repository_name, methods)

@mcp.tool(name="create_usecase")
def create_usecase(module_name: str, usecase_name: str, business_rules: str) -> str:
    """Generates an usecase file content following the usecase example."""
    return create_usecase_tool(module_name, usecase_name, business_rules)

@mcp.tool(name="create_usecase_test")
def create_usecase_test(module_name: str, usecase_name: str) -> str:
    """Generates an usecase test file content following the usecase test example."""
    return create_usecase_test_tool(module_name, usecase_name)
...
def create_controller(module_name: str, entity_name: str, usecase_name: str) -> str:
...
def create_controller_test(module_name: str, entity_name: str) -> str:
...
def create_viewmodel(module_name: str, viewmodel_name: str) -> str:
...
def create_viewmodel_test(module_name: str, viewmodel_name: str) -> str:
...
def create_repository_mongodb(module_name: str, repository_name: str, entity_name: str) -> str:
...
def create_repository_mongodb_test(repository_name: str) -> str:
...
def create_presenter(module_name: str, presenter_name: str) -> str:
...
def create_route(route_name: str, url_prefix: str) -> str:
    """Generates a new route and declare in server.py."""
    return create_route_tool(route_name, url_prefix)
