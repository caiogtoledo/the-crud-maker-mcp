...
def create_repository_mongodb_tool(repository_name: str, entity_name: str) -> str:
    """Generates a mongodb repository file content following the repository example."""
    return f"""Create a mongodb repository file in the folder /src/shared/infra/repositories/{repository_name}_mongodb.py for the entity {entity_name}.
