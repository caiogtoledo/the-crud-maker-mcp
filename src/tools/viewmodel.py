...
def create_viewmodel_tool(module_name: str, viewmodel_name: str) -> str:
    ...
    return f"""Create a viewmodel file in the folder /src/modules/{module_name}/app/viewmodels/{viewmodel_name}_viewmodel.py.
...
def create_viewmodel_test_tool(module_name: str, viewmodel_name: str) -> str:
    ...
    return f"""Create a viewmodel test file in the folder /tests/modules/{module_name}/app/viewmodels/{viewmodel_name}_viewmodel_test.py.
