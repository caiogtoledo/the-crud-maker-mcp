...
def create_controller_tool(module_name: str, entity_name: str, usecase_name: str) -> str:
    ...
    return f"""Create a controller file in the folder /src/modules/{module_name}/app/controllers/{entity_name}_controller.py for the usecase {usecase_name}.
...
def create_controller_test_tool(module_name: str, entity_name: str) -> str:
    ...
    return f"""Create a controller test file in the folder /tests/modules/{module_name}/app/controllers/{entity_name}_controller_test.py.
